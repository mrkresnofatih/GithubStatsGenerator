...
func MakeRecentReposScript(data []apis.GetRepositoriesResponse) {
	...
	for index, value := range data {
		...
		temp := "<p class=\"pack\"><span class=\"repotag\" style=\"background:" + color + ";color:white;\"><code>" + value.Name + "<\\/code><\\/span> <span class=\"rank\" style=\"background:whitesmoke;\">#" + strconv.Itoa(index+1) + "<\\/span><\\/p>"
